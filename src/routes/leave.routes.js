...
router.get(
  "/all-balances",
  checkPermission("perm_leave_view_all"), // Only admins/HR should see this
  getAllEmployeeBalances,
);

// --- STATS ROUTE (Must be before /:id routes) ---
router.get("/stats", checkPermission("perm_leave_view"), getLeaveStats);
...
router.get("/all", checkPermission("perm_leave_view"), getAllLeaves);
