...
export const createDeduction = async (req, res) => {
  try {
    ...
    // Check for our custom validation error
...
// ==========================================
// 3. UPDATE PLAN (Edit Name/Amount/Status)
// ==========================================
export const updatePlan = async (req, res) => {
  try {
    const { id } = req.params;
    // req.body contains { name, amount, status }
...
// ==========================================
// 5. MANAGE SUBSCRIBERS (Add/Remove People)
// ==========================================
export const updateSubscribers = async (req, res) => {
  try {
    const { id } = req.params;
    const { user_ids } = req.body; // Expecting: { user_ids: [9, 10] }
